...
if (window.location.pathname === '/admin/update') {
    ...
    window.openEditModal = (id) => {
      ...
      document.getElementById('editImagePreview').src = '/images/' + product.image_name;
    ...
    document.getElementById('editProductForm').addEventListener('submit', function (e) {
      ...
      axios.put(`/products/${selectedProductId}`, updatedData)
        .then(() => {
          products = products.map(p => p.product_id === selectedProductId ? { ...p, ...updatedData } : p);
          renderTable(products);
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', () => {
      axios.delete(`/products/${selectedProductId}`)
        .then(() => {
